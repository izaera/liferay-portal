...
export class TestEntityApi {
     ...
     * @param imageName 
     */
    public async postTestEntityMultipartImage (file?: RequestFile, imageName?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/test/v1.0/test-entities/multipart/image';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        let localVarFormParams: any = {};
        ...
        if (imageName !== undefined) {
            localVarFormParams['imageName'] = ObjectSerializer.serialize(imageName, "string");
        }
