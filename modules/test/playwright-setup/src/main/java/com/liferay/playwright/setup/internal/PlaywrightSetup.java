...
public class PlaywrightSetup {
	...
	protected void activate() {
		try {
			...
			_addDefaultOrganizationOwnerUser(organization);
	...
	private User _addDefaultOrganizationOwnerUser(Organization organization)
		throws PortalException {

		long companyId = organization.getCompanyId();
		String screenName = "default-organization-owner";
