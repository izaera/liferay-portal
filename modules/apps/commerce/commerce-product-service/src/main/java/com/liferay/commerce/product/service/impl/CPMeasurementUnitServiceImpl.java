...
public class CPMeasurementUnitServiceImpl
	...
	public CPMeasurementUnit fetchCPMeasurementUnitByKey(
		...
		CPMeasurementUnit cpMeasurementUnit =
			cpMeasurementUnitLocalService.fetchCPMeasurementUnitByKey(
				companyId, key);
	...
	public CPMeasurementUnit fetchPrimaryCPMeasurementUnitByType(
		...
		CPMeasurementUnit cpMeasurementUnit =
			cpMeasurementUnitLocalService.fetchPrimaryCPMeasurementUnitByType(
				companyId, type);
	...
	public CPMeasurementUnit getCPMeasurementUnitByKey(
		...
		CPMeasurementUnit cpMeasurementUnit =
			cpMeasurementUnitLocalService.getCPMeasurementUnitByKey(
				companyId, key);

		_cpMeasurementUnitModelResourcePermission.check(
			getPermissionChecker(), cpMeasurementUnit.getCPMeasurementUnitId(),
			ActionKeys.VIEW);
