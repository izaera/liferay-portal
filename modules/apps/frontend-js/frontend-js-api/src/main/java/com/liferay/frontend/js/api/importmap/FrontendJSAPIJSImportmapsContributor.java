...
package com.liferay.frontend.js.api.importmap;
...
public class FrontendJSAPIJSImportmapsContributor
	...
	protected void activate() {
		...
		_importmapsJSONObject.put(
			"@liferay/frontend-js-api", contextPath + "/__liferay__/index.js");
		_importmapsJSONObject.put(
			"@liferay/frontend-js-api/data-set",
			contextPath + "/__liferay__/data-set.js");
	}
	...
	@Reference(
		target = "(osgi.web.symbolicname=com.liferay.frontend.js.api)",
		unbind = "-"
	)
