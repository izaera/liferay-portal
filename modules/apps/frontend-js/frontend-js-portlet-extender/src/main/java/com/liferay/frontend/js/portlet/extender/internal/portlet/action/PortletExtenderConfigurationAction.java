...
public class PortletExtenderConfigurationAction
	...
	private static final String _TPL_CONFIGURATION_FORM_HTML;

	private static final String _TPL_CONFIGURATION_FORM_JS;

	private static final Log _log = LogFactoryUtil.getLog(
		PortletExtenderConfigurationAction.class);

	static {
		_TPL_CONFIGURATION_FORM_HTML = _loadTemplate(
			"configuration_form.html.tpl");
		_TPL_CONFIGURATION_FORM_JS = _loadTemplate("configuration_form.js.tpl");
	}
