...
public class JSConfigGeneratorPackage {
	...
	public JSConfigGeneratorPackage(
		...
		_setUnversionedJSConfigGeneratorModules();
	}
	...
	public List<JSConfigGeneratorModule> getUnversionedModules() {
		return _unversionedJSConfigGeneratorModules;
	}
	...
	private void _setUnversionedJSConfigGeneratorModules() {
		JSONObject jsonObject = _parse(_unversionedConfiguration, true);
		...
		for (Object key : jsonObject.keySet()) {
			...
			_unversionedJSConfigGeneratorModules.add(
	...
	private List<JSConfigGeneratorModule> _unversionedJSConfigGeneratorModules =
		new ArrayList<>();
