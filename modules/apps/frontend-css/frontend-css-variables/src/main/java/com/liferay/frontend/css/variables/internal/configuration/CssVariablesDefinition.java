 ...
 */
public class CssVariablesDefinition {

	public CssVariablesDefinition(JSONFactory jsonFactory) {
	...
	protected void parse(String json) throws JSONException {
		...
		for (String name : variablesJSONObject.keySet()) {
			...
			_cssVariableDefinitions.put(name, new CssVariableDefinition(label));
		}
	}
