 ...
 */
public class JSPackageCETImpl extends BaseCETImpl implements JSPackageCET {

	public JSPackageCETImpl(ClientExtensionEntry clientExtensionEntry) {
		super(clientExtensionEntry);
	}

	public JSPackageCETImpl(PortletRequest portletRequest) {
		this(
			StringPool.BLANK,
	...
	public String getEditJSP() {
		return "/admin/edit_js_package.jsp";
	}
	...
	public String getType() {
		return ClientExtensionEntryConstants.TYPE_JS_PACKAGE;
	}
	...
	private static final Set<String> _urlCETPropertyNames =
		getURLCETPropertyNames(JSPackageCET.class);
