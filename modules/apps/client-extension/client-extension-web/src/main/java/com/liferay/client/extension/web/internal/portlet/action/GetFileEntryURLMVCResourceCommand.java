...
@Component(
	...
	property = {
		...
		"mvc.command.name=/client_extension_admin/get_file_entry_url"
	},
	service = MVCResourceCommand.class
)
public class GetFileEntryURLMVCResourceCommand
	...
	protected void doServeResource(
		...
		try {
			...
			FileEntry fileEntry =
				_clientExtensionRepository.getFileEntry(fileEntryId);

			String url = _clientExtensionRepository.getURL(fileEntry);
