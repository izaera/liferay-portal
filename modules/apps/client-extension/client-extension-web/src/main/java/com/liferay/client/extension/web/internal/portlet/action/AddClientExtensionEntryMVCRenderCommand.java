...
import com.liferay.client.extension.web.internal.display.context.AddClientExtensionEntryDisplayContext;
...
public class AddClientExtensionEntryMVCRenderCommand
	...
	public String render(
		...
		try {
			renderRequest.setAttribute(
				...
				new AddClientExtensionEntryDisplayContext(renderRequest));

			return "/admin/add_client_extension_entry.jsp";
		}
