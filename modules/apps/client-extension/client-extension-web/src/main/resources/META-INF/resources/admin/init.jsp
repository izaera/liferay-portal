...
page import="com.liferay.client.extension.web.internal.display.context.AddClientExtensionEntryDisplayContext" %><%@
page import="com.liferay.client.extension.web.internal.display.context.ClientExtensionAdminDisplayContext" %><%@
page import="com.liferay.client.extension.web.internal.display.context.ClientExtensionItemSelectorDisplayContext" %><%@
