...
@Component(
	property = {
		JaxrsWhiteboardConstants.JAX_RS_APPLICATION_BASE + "=/clay-data-contributor",
...
public class ClayComponentApplication extends Application {
	...
	public Set<Object> getSingletons() {
		...
		set.add(_dataContributorResource);

		return set;
	}

	@Reference
	private ClayComponentDataContributorResource _dataContributorResource;
