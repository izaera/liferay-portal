...
<%@ include file="/remote-web-app/init.jsp" %>
...
>
	...
	<liferay-frontend:edit-form-body>
		...
		<liferay-frontend:fieldset-group>
			<aui:input label="remote-web-app-url" name="preferences--url--" type="text" value="<%= "http://www.google.com" %>" />
		</liferay-frontend:fieldset-group>
	...
	<liferay-frontend:edit-form-footer>
		<aui:button disabled="<%= false %>" type="submit" />
