...
page import="com.liferay.frontend.css.variables.CSSVariableDescription" %><%@
page import="com.liferay.frontend.css.variables.CSSVariableType" %><%@
page import="com.liferay.frontend.css.variables.theme.ThemeCSSVariableDescriptionsRegistry" %><%@
page import="com.liferay.layout.admin.constants.LayoutScreenNavigationEntryConstants" %><%@
page import="com.liferay.layout.admin.css.variables.LayoutSetCSSVariablesConfiguration" %><%@
