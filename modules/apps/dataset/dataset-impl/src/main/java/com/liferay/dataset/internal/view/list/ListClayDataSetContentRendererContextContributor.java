...
package com.liferay.dataset.internal.view.list;
...
import com.liferay.dataset.view.list.BaseListClayDataSetDisplayView;
 ...
 */
@Component(
	property = "clay.data.set.content.renderer.name=" + DatasetConstants.LIST,
