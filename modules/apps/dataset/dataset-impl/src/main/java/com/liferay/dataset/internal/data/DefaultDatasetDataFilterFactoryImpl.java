 ...
 * @author Marco Leo
 */
public class DefaultDatasetDataFilterFactoryImpl
	implements DatasetDataFilterFactory {

	@Override
	public DatasetDataFilter create(HttpServletRequest httpServletRequest) {
		DatasetDataFilterImpl datasetDataFilterImpl =
			new DatasetDataFilterImpl();

		datasetDataFilterImpl.setKeywords(
			ParamUtil.getString(httpServletRequest, "search"));

		return datasetDataFilterImpl;
	}
