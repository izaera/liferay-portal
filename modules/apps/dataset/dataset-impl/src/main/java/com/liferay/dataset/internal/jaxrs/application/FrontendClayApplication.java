...
import com.liferay.dataset.FilterFactoryRegistry;
import com.liferay.dataset.Pagination;
import com.liferay.dataset.internal.jaxrs.context.provider.PaginationContextProvider;
...
import com.liferay.dataset.provider.ClayDataSetProviderRegistry;
	...
	public Response saveActiveClayDataSetViewSettings(
		...
		try {
			...
			String currentActiveViewSettingsJSON = portalPreferences.getValue(
				DisplaySettingsNamespaceUtil.
					getClayDataSetDisplaySettingsNamespace(
						_portal, httpServletRequest, id),
