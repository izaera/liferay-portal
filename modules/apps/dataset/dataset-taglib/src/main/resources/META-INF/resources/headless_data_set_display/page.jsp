	...
	dataSetDisplay.default(
		{
			...
			filters: <%= jsonSerializer.serializeDeep(datasetFiltersContext) %>,
			...
			id: '<%= id %>',
			itemsActions: <%= jsonSerializer.serializeDeep(datasetActionDropdownItems) %>,
			namespace: '<%= namespace %>',
			...
			views: <%= jsonSerializer.serializeDeep(datasetViewsContext) %>,
		},
