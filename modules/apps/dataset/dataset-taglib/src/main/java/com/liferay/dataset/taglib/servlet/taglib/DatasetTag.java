 ...
 */
public class DatasetTag extends IncludeTag {
	...
	public String getDatasetDataProviderKey() {
		return _datasetDataProviderKey;
	}
	...
	public void setDatasetDataProviderKey(String datasetDataProviderKey) {
		_datasetDataProviderKey = datasetDataProviderKey;
	}
	...
	protected void setAttributes(HttpServletRequest httpServletRequest) {
		request.setAttribute(
			"dataset:dataset:actionParameterName", _actionParameterName);
		request.setAttribute(
			"dataset:dataset:activeViewSettingsJSON", _activeViewSettingsJSON);
		request.setAttribute("dataset:dataset:apiURL", _apiURL);
		request.setAttribute("dataset:dataset:appURL", _appURL);
		request.setAttribute(
			"dataset:dataset:bulkActionDropdownItems",
			_bulkActionDropdownItems);
		request.setAttribute(
			"dataset:dataset:clayPaginationEntries", _clayPaginationEntries);
		request.setAttribute("dataset:dataset:creationMenu", _creationMenu);
		request.setAttribute(
			"dataset:dataset:dataProviderKey", _datasetDataProviderKey);
		request.setAttribute(
			"dataset:dataset:datasetViewsContext", _datasetViewsContext);
		request.setAttribute("dataset:dataset:deltaParam", _deltaParam);
		request.setAttribute("dataset:dataset:formId", _formId);
		request.setAttribute("dataset:dataset:id", _id);
		request.setAttribute("dataset:dataset:itemsPerPage", _itemsPerPage);
		request.setAttribute("dataset:dataset:module", _module);
		request.setAttribute("dataset:dataset:namespace", _namespace);
		request.setAttribute("dataset:dataset:nestedItemsKey", _nestedItemsKey);
		request.setAttribute(
			"dataset:dataset:nestedItemsReferenceKey",
			_nestedItemsReferenceKey);
		request.setAttribute("dataset:dataset:pageNumber", _pageNumber);
		request.setAttribute(
			"dataset:dataset:paginationSelectedEntry",
			_paginationSelectedEntry);
		request.setAttribute("dataset:dataset:portletURL", _portletURL);
		request.setAttribute("dataset:dataset:selectedItems", _selectedItems);
		request.setAttribute(
			"dataset:dataset:selectedItemsKey", _selectedItemsKey);
		request.setAttribute("dataset:dataset:selectionType", _selectionType);
		request.setAttribute(
			"dataset:dataset:showManagementBar", _showManagementBar);
		request.setAttribute("dataset:dataset:showPagination", _showPagination);
		request.setAttribute("dataset:dataset:showSearch", _showSearch);
		request.setAttribute("dataset:dataset:style", _style);
		request.setAttribute(
	...
	private static final Log _log = LogFactoryUtil.getLog(DatasetTag.class);
